...
%end
save(['data/esstimegeyser' num2str(alliter)],'runtime','ess','numabove','numbelow');
%save(['data/esstimegeyser' num2str(alliter)],'runtime','ess','numabove','numbelow','numclusters');
