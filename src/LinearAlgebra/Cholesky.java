 ...
 * </ul>
 *
 * @see <a href="http://mathworld.wolfram.com/Cholesky.html">MathWorld</a>
 * @see <a href="http://en.wikipedia.org/wiki/Cholesky_decomposition">Wikipedia</a>
 * @version $Id: Cholesky.java 1244107 2012-02-14 16:17:55Z erans $
 * @since 2.0 (changed to concrete class in 3.0)
 *
 * Adapted by Yee Whye Teh for his own research purposes.
...
public class Cholesky {
     ...
     */
    public static final double DEFAULT_RELATIVE_SYMMETRY_THRESHOLD = 1.0e-6;
    /**
     * Default threshold below which diagonal elements are considered null
     * and matrix not positive definite.
     */
    public static final double DEFAULT_ABSOLUTE_POSITIVITY_THRESHOLD = 1.0e-6;
     ...
     * #Cholesky(RealMatrix, double, double)} with the
     ...
     * @see #Cholesky(RealMatrix, double, double)
     ...
     * @return log determinant of the matrix
     */
    ...
    static public boolean isPositiveDefinite(RealMatrix A) {
      try {
        Cholesky chol = new Cholesky(A);
